...
def get_train_dataset(image_path, image_size, num_bits, batch_size, ext='jpg', skip=None, **kwargs):
    del kwargs
...
def setup_data(config_dict,show_grid=False):
    ...
    num_images = len(glob.glob(f"{config_dict['image_path']}/*.{config_dict['ext']}"))
